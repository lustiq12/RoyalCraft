...
import net.luderspieler.royalcraft.procedures.deprecated.BlueGolemOnEntityTickUpdateProcedure;
...
public class BlueGolemEntity extends Monster {
	...
	public BlueGolemEntity(EntityType<BlueGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		BlueGolemOnEntityTickUpdateProcedure.execute(this.level(), this);
	}
