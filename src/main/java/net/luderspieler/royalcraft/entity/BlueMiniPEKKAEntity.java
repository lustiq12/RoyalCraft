...
import net.luderspieler.royalcraft.procedures.deprecated.BlueMiniPEKKAOnEntityTickUpdateProcedure;
...
public class BlueMiniPEKKAEntity extends Monster {
	...
	public BlueMiniPEKKAEntity(EntityType<BlueMiniPEKKAEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		BlueMiniPEKKAOnEntityTickUpdateProcedure.execute(this.level(), this);
	}
