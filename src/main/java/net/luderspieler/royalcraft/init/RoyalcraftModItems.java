...
import net.luderspieler.royalcraft.item.MiniPEKKAitemItem;
import net.luderspieler.royalcraft.item.GolemItemItem;
import net.luderspieler.royalcraft.item.MinionItemItem;
import net.luderspieler.royalcraft.item.GiantItemItem;
import net.luderspieler.royalcraft.item.BarbarianItemItem;
