package net.luderspieler.royalcraft.procedures.deprecated;
...
public class RedBarbarianOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (RoyalcraftModVariables.WorldVariables.get(world).WorldTimer == 1) {
			Targetentity = lvl.getEntitiesOfClass(LivingEntity.class, new AABB(x - 40, y - 40, z - 40, x + 40, y + 40, z + 40), e -> e.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.tryParse("royalcraft:blue")))).stream()
